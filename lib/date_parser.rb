class DateParser
  ...
  MONTH_YEAR_PATTERN = regexp('^(jan|january|feb|february|mar|march|apr|april|may|jun|june|jul|july|aug|august|sep|september|oct|october|nov|november|dec|december) ((18|19|20)\d\d)\.?$','i')
  ...
  YEAR_PATTERN = regexp('^((18|19|20)\d\d)\.?$')
