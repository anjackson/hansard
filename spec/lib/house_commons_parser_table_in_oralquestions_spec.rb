...
describe Hansard::HouseCommonsParser do
  ...
  it "should create table contribution for table in p element in section element" do
    ...
    debates.sections[0].title.should == 'ORAL ANSWERS TO<lb></lb> QUESTIONS'
    ...
    table.image_src_range.should == 'S5CV0976P1I0146'
  ...
  it "should create table contribution for table element in section element" do
    ...
    continue_table.image_src_range.should == 'S5CV0976P1I0147'
