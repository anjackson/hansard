...
describe HouseOfCommonsSitting, " destroy" do
  ...
  it 'should destroy child debates, oral questions, sections, contributions, divisions and votes' do
    ...
    sitting.debates.sections[1].sections[0].questions[0].contributions << MemberContribution.new(:oral_question_no=>1, :xml_id=>"S5CV0602P0-00252", :member=>"Mr. John Hall", :text=>"<p>asked the Chancellor of the Duchy of Lancaster what steps he has taken to ensure that an adequate supply of suitable British filmed material is available to countries starting television services.</p>")
